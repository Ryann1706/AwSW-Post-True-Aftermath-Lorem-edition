...
menu:
    "Yeah.":
        c "Yeah. I learned about it in school. When it hits, it will send enough debris into the air that it’ll block out the sun and freeze the planet in a winter that lasts a decade. It will destroy the ecosystem, and everything heavier than a kilogram will die within a year."
...
menu:
    "Adine":
        ...
        c "Adine would. Being a flyer would be very beneficial, and because of her job, she’s very experienced with interacting with people."
...
Lo relieved "I was, but the thought of living in the human world and actually doing it are two completely different things."
...
menu:
    ...
    "Do I need a reason?":
        c "Do I need a reason to spend time with you, other than because I wanted to?"
...
menu: 
    ...
    "Do you want to come in?":
        ...
        c "Well, you can just call Ipsum from my phone and tell him you'll be here."
        $ renpy.pause (2.0)
