...
c "How come you two still are living together anyway? I’m sure you could get separate apartments if you asked."
...
$ renpy.pause (2.0)
c "Sorry I already forgot, but what was it that Lorem had to go out to do?"
...
Lo relieved flip "Seriously, though. You could have gotten anything, but you choose this?"
$ renpy.pause (1.0)
show lorem think flip with dissolve
$ renpy.pause (1.0)
Lo relieved flip "Wait. This better not be your old one, and you got a newer one to replace it, Ipsum…"
...
menu:
    "You deserve it for all the work you put in.":
        ...
        c "Lorem, you deserve something nice like this for all the hard work and effort you put in."
    ...
    "I hope you enjoy it.":
        ...
        Ip "Yes. I’m sorry you’re not too thrilled, but do hope you enjoy it too."
        $ renpy.pause (1.5)
        Lo think flip "Actually, I should rephrase what I said."
        Lo normal flip "I know I don’t seem too excited about the gift, but I do appreciate it, and I can see the funny side too. So, thank you for getting me this."
...
c "Is it because humans wear clothes, and everyone is in the human world now, so he want to try and fit in?"
Lo "They mentioned they’ve had it for a while now, so I don’t think so."
c "Why are there wearing it then?"
...
menu:
    ...
    "It’s pretty weird.":
        ...
        Lo relieved flip "It’s not Andreas' fault that they hatched that way, and they can’t control that. So just don’t judge them for it, please."
        c "…"
        c "Right. I’m sorry."
        show lorem think flip with dissolve 
        $ renpy.pause (2.0)
    ...
    "I didn’t even notice.":
        ...
        Lo normal flip "Well, basically, their eyes are different colours, because of a mutation when they hatched."
...
menu:
    ...
    "It unfair your office is so much nicer.":
        $ ryann_lorem_true_mood -= 1
...
$ renpy.pause (2.5)
Lo "It’s hard to give an accurate time estimate, but assuming we get some more people working with us, we should have a demo finished in… roughly 3 to 4 months."
menu: 
    "I’m interested to see how the extra resources you have will change your game.":
        ...
        Lo think flip "Before, it was just me working on it, still working a full-time job. But now, I’ll, hopefully soon, be working with a team of people."

    "I thought you’d have more done.":
        $ ryann_lorem_true_mood -= 1
        c "I thought you’d have more done with all this extra help you’re getting."
...
Lo normal flip "I’d take a guess and say you won't find things like being shown a bathroom, storage area, and janitor closet exiting."
c "You’d be right in that guess."
...
c "You’re making it sound like I did that last thing singlehandedly."
Lo "You don’t have to be so humble. If it weren't for you, and everything you went through, nothing would have happened in the first place. So you technically are the reason both of our species were saved."
$ renpy.pause (1.5)
...
menu:
    ...
    "Friends are always there for each other.":
        ...
        Lo think flip "Right, but our friendship seems to be a bit one-sided then."
...
Ry normal flip "It’s definitely not what I expected to happen, but I couldn’t be happier things turned out this way."
...
menu: 
    ...
    "Lorem is too cute to resist.":
        ...
        Lo "[player_name]!"
        Ad "Lorem, calm down. We’re just pulling tail."
        show adine normal b flip with dissolve 
...
Ry smile flip "Plus, it's pretty convenient having a free hatching sitter if we need it."
...
menu:
    ...
    "Omelet":
        $ ryann_lorem_true_food_choice = "omelet"
        c "I’ll have an omelet."
...
Lo think "I thought it would be easier this way, in case there was any kind of questions or explanations that specifically humans needed."
Lo "And even though we’re all in the human world now, there are still dragons that have a big interest in, or are easily excited around humans, and I didn’t want anyone feeling overwhelmed, uncomfortable, or anything bad like that."
...
menu:
    ...
    "Keep an ice cube in your mouth until it melts.":
        ...
        m "Lorem plucked an ice cube from their drink and proceed to put it in their mouth."
...
if ryann_lorem_true_minigame_random1 < 4:
    ...
    if ryann_lorem_true_minigame_random1 == 1: # Remy
        ...
        m "I tried desperately to focus on eating and avoiding looking even in their general direction."
        ...
        $ renpy.pause (1.5)
        m "A few seconds later a got a text."
        ...
        c "I feel bad he went through the effort to get his phone, and text me back, but it was all for nothing."
...
menu:
    "What is your biggest fear?":
        ...
        Lo "My biggest fear?"
        $ renpy.pause (1.5)
        Lo sad "I mentioned it before, it’s probably having to step into the limelight and letting the world know I’m a hermaphrodite, and that I have to do it eventually if I want to finish my game."
        Lo think "Like I said before, I told everyone who showed up for my interview, and that was unnerving enough, but I wasn’t as bad as my fears were telling me it would be."
        if ryann_lorem_true_humanity_reaction == "accepted":
            ...
            Lo relieved  "You said humanity might react harshly, and that makes it even harder for me to do, but I’m still holding on to hope that you’re wrong on that."

        $ renpy.pause (2.0)
        c "I probably shouldn’t have brought that up. I’m sorry."
        Lo normal "You don’t have to applolagze. There’s no point trying to avoid it, and not talk about it. It’s something inevitable I need to deal with."
        $ renpy.pause (1.5)
        c "Let’s move on to the next round."
    ...
    "Do you have a crush on anyone?":
        ...
        if ryann_lorem_true_romance == 3:
            ...
            Lo normal "Lo: I’m pretty sure I don’t. No one immediately comes to mind at least."
...
if ryann_lorem_true_minigame_random2 == 1: # Salt
    ...
    m "I immediately almost gagged, and all the moisture was sucked out of my mouth."
    show lorem happy with dissolve 
...
Lo normal "You said I can make you do something embarrassing, as long as it’s within reason, so that’s what’ll do."
...
if ryann_lorem_true_minigame_random3 == 1:
    ...
    menu:
        ...
        "Wealth":
            $ ryann_lorem_true_romance -= 1
            $ ryann_lorem_true_mood -= 1
            c "I think I find how wealthy someone is, is what I find most attractive."
...
menu:
    "Improv a random conversation with Adine and Remy.":
        ...
        m "They were too far a way for me to hear, but I could tell Lorem’s approach was very unprecedented."
    ...
    "Kiss me.":
        ...
        menu:
            ...
            "Lips":
                ...
                m "Lorem then slowly shuffled over, and stood in front of me. And I proceed to lower myself down slightly to match their height."
                $ renpy.pause (1.5)
                show lorem shy with dissolve 
                $ renpy.pause (1.0)
                play sound "fx/kiss.wav"
...
c "How?"
Lo happy "So, we have a pizza party, order lots of pizzas, and each pizza has its own individual topping. Then we just figure out which is option the best from there!"
...
Lo normal "Even some of your myths have are very alike to some of our own."
c "Speaking of our myths, did you ever get a chance to look at some of ours about dragons?"
Lo happy "I did, actually!"
Lo "As I expected, not all of them are accurate, but some are shocking close! It’s almost like certain dragon species were based on some of those myths."
...
if ryann_lorem_true_mood < 6:
    ...
    menu: 
        "Move closer to Lorem":
            ...
            m "I moved closer to Lorem, sliding down the bench, so their tail was now bruising up on my leg."
            show lorem shy with dissolve 
    ...
    c "But that doesn’t matter I can just forget the times when I couldn’t!"
    show lorem sad with dissolve
    $ renpy.pause (2.0)
    play sound "fx/undress.ogg"
    ...
    c "I guess in the end, I guess it was worth it. Because now I can focus on the present, and look forward to the future."
    ...
    if ryann_lorem_true_romance > 3:
        menu:
            "Kiss Lorem":
                ...
                m "We parted shortly after, and continued to stare into each other's eyes for a few moments after."
                $ renpy.pause (1.5)
                ...
                $ renpy.pause (3.5)
                m "And just like that, the purring slowed faded, then soon stopped, and Lorem was fast asleep on my lap."
...
c "I really expect there to be more to it than that."
...
Lo relieved flip "But I can’t keep ignoring this, and trying to stay ignorant."
